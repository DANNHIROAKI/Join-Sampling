...
//
// Examples:
//   ./sjs_gen --dataset_source=synthetic --gen=stripe --dataset=demo \
...
inline void PrintUsage() {
  std::cerr
      << "sjs_gen: synthetic dataset generator\n\n"
      << "Required:\n"
...
int main(int argc, char** argv) {
  ...
  if (cfg.dataset.source != sjs::DataSource::Synthetic) {
    SJS_LOG_ERROR("sjs_gen requires --dataset_source=synthetic");
    return 2;
  }
