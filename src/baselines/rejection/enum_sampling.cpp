// src/baselines/rejection/enum_sampling.cpp
//
/* Explicit template instantiation for rejection::RejectionEnumSamplingBaseline in 2D.
 *
...
template class RejectionEnumSamplingBaseline<2, sjs::Scalar>;
