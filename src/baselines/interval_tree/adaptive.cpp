// src/baselines/interval_tree/adaptive.cpp
//
/* Explicit template instantiation for interval_tree::IntervalTreeAdaptiveBaseline in 2D.
 *
...
template class IntervalTreeAdaptiveBaseline<2, sjs::Scalar>;
