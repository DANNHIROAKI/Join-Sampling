// src/baselines/interval_tree/enum_sampling.cpp
//
/* Explicit template instantiation for interval_tree::IntervalTreeEnumSamplingBaseline in 2D.
 *
...
template class IntervalTreeEnumSamplingBaseline<2, sjs::Scalar>;
