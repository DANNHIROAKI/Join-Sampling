// src/baselines/kd_tree/enum_sampling.cpp
//
/* Explicit template instantiation for kd_tree::KDTreeEnumSamplingBaseline in 2D.
 *
...
template class KDTreeEnumSamplingBaseline<2, sjs::Scalar>;
