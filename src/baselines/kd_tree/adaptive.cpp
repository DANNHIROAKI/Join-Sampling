// src/baselines/kd_tree/adaptive.cpp
//
/* Explicit template instantiation for kd_tree::KDTreeAdaptiveBaseline in 2D.
 *
...
template class KDTreeAdaptiveBaseline<2, sjs::Scalar>;
