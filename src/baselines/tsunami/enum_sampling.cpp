// src/baselines/tsunami/enum_sampling.cpp
//
/* Explicit template instantiation for tsunami::TsunamiEnumSamplingBaseline in 2D.
 *
...
template class TsunamiEnumSamplingBaseline<2, sjs::Scalar>;
