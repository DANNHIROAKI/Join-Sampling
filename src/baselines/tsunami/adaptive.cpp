// src/baselines/tsunami/adaptive.cpp
//
/* Explicit template instantiation for tsunami::TsunamiAdaptiveBaseline in 2D.
 *
...
template class TsunamiAdaptiveBaseline<2, sjs::Scalar>;
