// src/baselines/r_tree/sampling.cpp
//
/* Explicit template instantiation for r_tree::RTreeSamplingBaseline in 2D.
 *
...
template class RTreeSamplingBaseline<2, sjs::Scalar>;
