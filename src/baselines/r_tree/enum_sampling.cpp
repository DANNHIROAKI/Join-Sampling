// src/baselines/r_tree/enum_sampling.cpp
//
/* Explicit template instantiation for r_tree::RTreeEnumSamplingBaseline in 2D.
 *
...
template class RTreeEnumSamplingBaseline<2, sjs::Scalar>;
