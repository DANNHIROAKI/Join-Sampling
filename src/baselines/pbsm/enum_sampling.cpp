// src/baselines/pbsm/enum_sampling.cpp
//
/* Explicit template instantiation for pbsm::PBSMEnumSamplingBaseline in 2D.
 *
...
template class PBSMEnumSamplingBaseline<2, sjs::Scalar>;
