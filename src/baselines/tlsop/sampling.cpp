// src/baselines/tlsop/sampling.cpp
//
/* Explicit template instantiation for tlsop::TLSOPSamplingBaseline in 2D.
 *
...
template class TLSOPSamplingBaseline<2, sjs::Scalar>;
