// src/baselines/tlsop/enum_sampling.cpp
//
/* Explicit template instantiation for tlsop::TLSOPEnumSamplingBaseline in 2D.
 *
...
template class TLSOPEnumSamplingBaseline<2, sjs::Scalar>;
