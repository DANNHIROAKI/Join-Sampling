// src/baselines/sirs/enum_sampling.cpp
//
/* Explicit template instantiation for sirs::SIRSEnumSamplingBaseline in 2D.
 *
...
template class SIRSEnumSamplingBaseline<2, sjs::Scalar>;
